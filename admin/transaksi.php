...
<h3><span class="glyphicon glyphicon-briefcase"></span>  Transaksi</h3>
...
<?php 
$per_hal=10;
$jumlah_record=mysqli_query($con, "SELECT COUNT(*) as jumlah from barang");
while($row = mysqli_fetch_assoc($jumlah_record)) {
	$jum = $row['jumlah'];
 }
